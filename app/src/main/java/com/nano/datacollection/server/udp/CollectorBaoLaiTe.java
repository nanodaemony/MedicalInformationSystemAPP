 ...
 * @author cz
 */
public class CollectorBaoLaiTe implements Collector {

    /**
     * Logger
     */
    private Logger logger = new Logger("CollectorBaoLaiTe");
     ...
     */
    public CollectorBaoLaiTe(MedicalDevice medicalDevice) {
    ...
    public void startCollection() {
        ...
        // 执行接收任务
        ThreadPoolUtils.executeNormalTask(controlRunnable);
        ThreadPoolUtils.executeNormalTask(receiveRunnable);
    ...
    private Runnable controlRunnable = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                logger.error("Open socket error");
                e.printStackTrace();
               // TODO:通知外面是否开启成功
            }
