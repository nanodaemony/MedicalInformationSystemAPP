...
/**
 * Description: 迈瑞WATOEX65采集器 基于Netty实现
 *
 * @version: 1.0
 * @author: nano
 ...
 */
@Deprecated
public class CollectorMaiRuiWatoex65Netty implements Collector {
    /**
     * Logger
     */
     ...
     * 构造器
     */
    public CollectorMaiRuiWatoex65Netty(MedicalDevice medicalDevice) {
